...
\usepackage[table]{xcolor}  % Silbentrennung nach der neuen deutschen Rechtschreibung, z.B.: Sys-tem
...
\newcommand{\TheAuthor}{}
\newcommand{\MarR}{Riccardo Martin}
\newcommand{\PfnM}{Michael Pfnür}
\newcommand{\ZotD}{Daniel Zotter}
...
\renewcommand{\TheAuthor}{\ZotD}
\include{Abstract}
\renewcommand{\TheAuthor}{}
\pagestyle{empty}
...
\renewcommand{\TheAuthor}{\PfnM}
\include{Einleitung}
\include{TheoretischerTeil}
\renewcommand{\TheAuthor}{\ZotD}
\include{NEMO}
\include{PraktischerTeil_Materialien_Aufbau}
\renewcommand{\TheAuthor}{\MarR}
\include{Analyse_&_Config}
...
\textbf{HA}&\makebox[0.6cm]{\dotfill} & Home Agent\\
\textbf{MN}&\makebox[0.6cm]{\dotfill} & Mobile Node\\
\textbf{CN}&\makebox[0.6cm]{\dotfill} & Correspondent Node \\
\textbf{CoA}&\makebox[0.6cm]{\dotfill} & Care-of Address\\
\textbf{HoA}&\makebox[0.6cm]{\dotfill} & Home Adresse\\
\textbf{IOS}&\makebox[0.6cm]{\dotfill} &Internetwork Operating System\\
\textbf{MR}&\makebox[0.6cm]{\dotfill} & Mobile Router\\
\textbf{NEMO}&\makebox[0.6cm]{\dotfill} &Network Mobility\\
\end{tabular}
...
\include{Anhang/ISP_Config}                 % A
\addcontentsline{toc}{section}{Anhang B}
\include{Anhang/Anhang_WLAN}
\addcontentsline{toc}{section}{Anhang C}
\include{Anhang/MobileRouter_Grund}    				% B
